...
| [17-deferred.md](17-deferred.md) | Work deliberately **not** built — khata (customer credit), day-close, the stock ledger — each with its reason and the trigger to build it. |
